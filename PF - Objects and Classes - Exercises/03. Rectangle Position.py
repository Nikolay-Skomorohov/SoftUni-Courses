...
while input_list[0] != "go go go":
    input_object = Exercise(input_list[0], input_list[1], input_list[2], input_list[3].split(", "))
    data_list.append(input_object)
    input_list = input().split(" -> ")

for obj in data_list:
    print(f"Exercises: {obj.topic}")
    print(f"Problems for exercises and homework for the \"{obj.course_name}\" course @ SoftUni.")
